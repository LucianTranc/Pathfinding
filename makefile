...
pathfinding: main.o
	$(CC) $(CFLAGS) $(INC_PATH) $(LDFLAGS) -framework OpengL bin/main.o bin/Game.o bin/Grid.o bin/MazeManager.o -o play

main.o: main.cpp bin/Game.o bin/Grid.o bin/MazeManager.o
...
bin/MazeManager.o: MazeManager.cpp MazeManager.h
	$(CC) $(CFLAGS) $(INC_PATH) MazeManager.cpp -c -o bin/MazeManager.o
